...
function ProtocolLogin:parseCharacterList(msg)
  ...
  if g_game.getClientVersion() > 1010 then
    ...
    for i=1,charactersCount do
	  ...
	  --if character.name == "Karmena" or character.name == "Admin Vultur" then
	      argType = msg:getU16()
		  argHead = msg:getU8()
		  argBody = msg:getU8()
		  argLegs = msg:getU8()
		  argFeet = msg:getU8()
		  argAddons = msg:getU8()
		  character.outfit = {["type"]=argType,["addons"]=argAddons,["head"]=argHead,["body"]=argBody,["legs"]=argLegs,["feet"]=argFeet}
		  character.online = msg:getU8()
		  character.level = msg:getU16()
		  character.maxHp = msg:getU32()
		  character.hp = msg:getU32()
		  character.maxKi = msg:getU32()
		  character.ki = msg:getU32()
		  character.effect = msg:getU16()
		  character.aura = msg:getU16()
	  --[[else
	      character.outfit = {["type"]=100,0,0,0,0}
		  character.online = 0
		  character.level = 1
		  character.maxHp = 33
		  character.hp = 1
