...
function refresh()
 ...
 -- expSpeedEvent = cycleEvent(checkExpSpeed, 30*1000)
  ...
  onBalanceChange(player, player:getBalance())  
  ...
  if hasAdditionalSkills then
    ...
    skillsWindow:setContentMaximumHeight(350)
  end
...
function onStaminaChange(localPlayer, stamina)
  ...
  local percent = math.floor(100 * stamina / (6 * 60)) -- max is 42 hours
...
function onStatesChange(localPlayer, now, old)
  ...
  for i = 1, 32 do
	...
	if bitChanged == 32 and speedBit[32] == 0 then
	  speedBit[32] = 1
	elseif bitChanged == 32 and speedBit[32] == 1 then
	  speedBit[32] = 0
	end
	if bitChanged == 64 and speedBit[64] == 0 then
	  speedBit[64] = 1
	elseif bitChanged == 64 and speedBit[64] == 1 then
	  speedBit[64] = 0
	end
  end
  
	if speedBit[32] and speedBit[32] == 1 then
	  setSkillColor('speed', 'red')
	elseif speedBit[64] and speedBit[64] == 1 then
	  setSkillColor('speed', 'green')
	elseif speedBit[32] == 0 and speedBit[64] == 0 then
	  setSkillColor('speed', 'white')
	end
end
...
function onSkillChange(localPlayer, id, level, percent)
  ...
  --TEST setSkillValue('skillId' .. id, level .. " N : Base " .. localPlayer:getSkillBaseLevel(id))
