...
function init()
  ...
  g_ui.importStyle('styles/withdrawmoneywindow')
...
function getShowTopButton()
	return gameMapPanel:getChildById('showTopMenuButton2')
end
...
function hide()
  ...
  if withdrawMoneyWindow then
    withdrawMoneyWindow:destroy()
    withdrawMoneyWindow = nil
  end
  gameRootPanel:hide()
...
function withdrawMoneyFromBank()
  if withdrawMoneyWindow then
    return
  end
  ...
  withdrawMoneyWindow = g_ui.createWidget('WithdrawMoneyWindow', rootWidget)
  local itembox1 = withdrawMoneyWindow:getChildById('item1')
  local itembox2 = withdrawMoneyWindow:getChildById('item2')
  local itembox3 = withdrawMoneyWindow:getChildById('item3')
  local itembox4 = withdrawMoneyWindow:getChildById('item4')
  local scrollbar1 = withdrawMoneyWindow:getChildById('countScrollBar1')
  local scrollbar2 = withdrawMoneyWindow:getChildById('countScrollBar2')
  local scrollbar3 = withdrawMoneyWindow:getChildById('countScrollBar3')
  local scrollbar4 = withdrawMoneyWindow:getChildById('countScrollBar4')
  local itemLabel1 = withdrawMoneyWindow:getChildById('itemLabel1')
  local itemLabel2 = withdrawMoneyWindow:getChildById('itemLabel2')
  local itemLabel3 = withdrawMoneyWindow:getChildById('itemLabel3')
  local itemLabel4 = withdrawMoneyWindow:getChildById('itemLabel4')
  
  itembox1.onClick =
    function()
		itembox1:setEnabled(false)
		itemLabel1:setOpacity(0.3)
		itembox1:setItemCount(0)
		scrollbar1:setValue(0)
    end
	
  itembox2.onClick =
    function()
		itembox2:setEnabled(false)
		itemLabel2:setOpacity(0.3)
		itembox2:setItemCount(0)
		scrollbar2:setValue(0)
    end
	
  itembox3.onClick =
    function()
		itembox3:setEnabled(false)
		itemLabel3:setOpacity(0.3)
		itembox3:setItemCount(0)
		scrollbar3:setValue(0)
    end
	
  itembox4.onClick =
    function()
		itembox4:setEnabled(false)
		itemLabel4:setOpacity(0.3)
		itembox4:setItemCount(0)
		scrollbar4:setValue(0)
    end
  
  if(balance >= 1000000)then
    local lp = math.min(math.floor(balance / 1000000), 100)
	itembox1:setItemCount(lp)
	itembox1:setEnabled(true)
	scrollbar1:setEnabled(true)
	scrollbar1:setMaximum(lp)
	scrollbar1:setMinimum(0)
	scrollbar1:setValue(lp)
  else
	itembox1:setEnabled(false)
  ...
  if(balance >= 10000)then
    local lp = math.min(math.floor(balance / 10000), 100)
	itembox2:setItemCount(lp)
	itembox2:setEnabled(true)
	scrollbar2:setEnabled(true)
	scrollbar2:setMaximum(lp)
	scrollbar2:setMinimum(0)
	scrollbar2:setValue(lp)
  else
	itembox2:setEnabled(false)
  ...
  if(balance >= 100)then
    local lp = math.min(math.floor(balance / 100), 100)
	itembox3:setItemCount(lp)
	itembox3:setEnabled(true)
	scrollbar3:setEnabled(true)
	scrollbar3:setMaximum(lp)
	scrollbar3:setMinimum(0)
	scrollbar3:setValue(lp)
  else
	itembox3:setEnabled(false)
  ...
  if(balance >= 1)then
    local lp = math.min(balance, 100)
	itembox4:setItemCount(lp)
	itembox4:setEnabled(true)
	scrollbar4:setEnabled(true)
	scrollbar4:setMaximum(lp)
	scrollbar4:setMinimum(0)
	scrollbar4:setValue(lp)
  else
	itembox4:setEnabled(false)
  ...
  local spinbox = withdrawMoneyWindow:getChildById('spinBox')
  spinbox:setMaximum(count)
  spinbox:setMinimum(0)
  spinbox:setValue(0)
  spinbox:hideButtons()
  ...
  scrollbar1.onValueChange = function(self, value)
    itembox1:setItemCount(value)
    spinbox.onValueChange = nil
    spinbox:setValue(value)
    spinbox.onValueChange = spinBoxValueChange
	if(value > 0)then
		itembox1:setEnabled(true)
		itemLabel1:setOpacity(0)
	else
		itembox1:setEnabled(false)
		itemLabel1:setOpacity(0.3)
	end
  ...
  scrollbar2.onValueChange = function(self, value)
    itembox2:setItemCount(value)
	if(value > 0)then
		itembox2:setEnabled(true)
		itemLabel2:setOpacity(0)
	else
		itembox2:setEnabled(false)
		itemLabel2:setOpacity(0.3)
	end
  ...
  scrollbar3.onValueChange = function(self, value)
    itembox3:setItemCount(value)
	if(value > 0)then
		itembox3:setEnabled(true)
		itemLabel3:setOpacity(0)
	else
		itembox3:setEnabled(false)
		itemLabel3:setOpacity(0.3)
	end
  ...
  scrollbar4.onValueChange = function(self, value)
    itembox4:setItemCount(value)
	if(value > 0)then
		itembox4:setEnabled(true)
		itemLabel4:setOpacity(0)
	else
		itembox4:setEnabled(false)
		itemLabel4:setOpacity(0.3)
	end
  ...
  local okButton = withdrawMoneyWindow:getChildById('buttonOk')
  local moveFunc = function()
    --g_game.move(item, toPos, itembox:getItemCount())
	g_game.talk('!withdraw ' .. math.min(((itembox1:getItemCount()*1000000)+(itembox2:getItemCount()*10000)+(itembox3:getItemCount()*100)+(itembox4:getItemCount())), balance) .. '')
    okButton:getParent():destroy()
    withdrawMoneyWindow = nil
  end
  local cancelButton = withdrawMoneyWindow:getChildById('buttonCancel')
  local cancelFunc = function()
    cancelButton:getParent():destroy()
    withdrawMoneyWindow = nil
  end

  withdrawMoneyWindow.onEnter = moveFunc
  withdrawMoneyWindow.onEscape = cancelFunc
...
function setupViewMode(mode)
  ...
  if mode == 0 then
    ...
    gameLeftPanel:setMarginTop(0)
    gameRightPanel:setMarginTop(0)
   -- gameLeftPanel:fill('parent')
	--modules.client_topmenu.getTopMenu():fill('parent')
   ...
   -- gameMapPanel:setLimitVisibleRange(limit)
    ...
    gameRightPanel:setMarginTop(modules.client_topmenu.getTopMenu()
      :getHeight() - gameRightPanel:getPaddingTop())
	      ...
	      gameLeftPanel:setMarginTop(modules.client_topmenu.getTopMenu()
      :getHeight() - gameLeftPanel:getPaddingTop())]]--
	  modules.client_topmenu.getTopMenu():setMarginRight(gameRightPanel:getWidth())
	--  modules.client_topmenu.getTopMenu():setMarginLeft(gameLeftPanel:getWidth())
	 -- gameLeftPanel = gameRootPanel:getChildById('gameLeftPanel')
	 -- modules.client_topmenu.getTopMenu():setMarginLeft(gameRightPanel:getWidth())
