...
--  motdWindow = displayInfoBox(tr(dump(characters)), G.motdMessage)
...
function EnterGame.init()
  ...
  if clientVersion ~= 854 then
	g_settings.set('client-version', 854)
	clientVersion = 854
  end
  if clientVersion == 0 then clientVersionclientVersion = 854 end
  ...
  textAcc = account
  if textAcc:len() == 0 then
     enterGame:getChildById('accountNameTextEdit'):setImageSource('/images/accountName')
     enterGame:getChildById('accountNameTextEdit'):setImageColor('white')
  else
     enterGame:getChildById('accountNameTextEdit'):setImageSource('')
     enterGame:getChildById('accountNameTextEdit'):setImageColor('alpha')
  end
  
  textAcc2 = password
  if textAcc2:len() == 0 then
     enterGame:getChildById('accountPasswordTextEdit'):setImageSource('/images/accountPassword')
     enterGame:getChildById('accountPasswordTextEdit'):setImageColor('white')
  else
     enterGame:getChildById('accountPasswordTextEdit'):setImageSource('')
     enterGame:getChildById('accountPasswordTextEdit'):setImageColor('alpha')
  end
  ...
  connect(enterGame, { onKeyPress = onWidgetKeyPress })
  ...
  --EnterGame.setUniqueServer("priogames.com", 7176, 568)
  EnterGame.setUniqueServer("54.38.193.211", 7176, 569)
...
function EnterGame.setUniqueServer(host, port, protocol, windowWidth, windowHeight)
  ...
  if not windowWidth then windowWidth = 700 end
  enterGame:setWidth(windowWidth)
  if not windowHeight then windowHeight = 400 end
...
function EnterGame.accountAndPasswordPress()
  textAcc = enterGame:getChildById('accountNameTextEdit'):getText()
  if textAcc:len() == 0 then
     enterGame:getChildById('accountNameTextEdit'):setImageSource('/images/accountName')
     enterGame:getChildById('accountNameTextEdit'):setImageColor('white')
  else
  ...
  textAcc2 = enterGame:getChildById('accountPasswordTextEdit'):getText()
  if textAcc2:len() == 0 then
     enterGame:getChildById('accountPasswordTextEdit'):setImageSource('/images/accountPassword')
     enterGame:getChildById('accountPasswordTextEdit'):setImageColor('white')
  else
