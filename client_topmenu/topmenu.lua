...
function toggle()
  ...
  if menu:getHeight() > 0 then
  --if menu:isVisible() then
    --menu:hide()
	topMenu:setHeight(0)
	modules.game_interface:getShowTopButton():setImageSource('/images/ui/menushow2')
---modules.game_interface.getShowTopButton():addAnchor(AnchorTop, 'parent', AnchorTop)
  --  modules.client_background.getBackground():addAnchor(AnchorTop, 'parent', AnchorTop)
   ...
   -- menu:show()
   topMenu:setHeight(40)
   modules.game_interface:getShowTopButton():setImageSource('/images/ui/menushow')
 --modules.game_interface.getShowTopButton():addAnchor(AnchorTop, 'topMenu', AnchorTop)
