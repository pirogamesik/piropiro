...
function init()
  ...
  --audioPanel = g_ui.loadUI('audio')
  optionsTabBar:addButton(tr('Hotkeys'), showHotkeys, '/images/optionstab/hotkeys')

  --optionsButton = modules.client_topmenu.addLeftButton('optionsButton', tr('Options'), '/images/topbuttons/options', toggle)
  --audioButton = modules.client_topmenu.addLeftButton('audioButton', tr('Audio'), '/images/topbuttons/audio', function() toggleOption('enableAudio') end)
  audioButtonNew = modules.client_background.getMusicButton()
  audioButtonNew.onClick = function() toggleOption('enableAudio') end
...
function setOption(key, value, force)
  ...
  elseif key == 'enableAudio' then
    ...
    if value then
	  ...
	  audioButtonNew:setIcon('/images/sound')
    else
      --audioButton:setIcon('/images/topbuttons/audio_mute')
	  audioButtonNew:setIcon('/images/sound2')
    end
  ...
  elseif key == 'displayCircles' then
		modules.game_healthcircle.update()
